...
${OBJECTDIR}/_ext/46522b86/xkerror.o: ../tcpserial/xkerror.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/Cellar/jsoncpp/1.8.4/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/46522b86/xkerror.o ../tcpserial/xkerror.cpp

${OBJECTDIR}/_ext/46522b86/xkserial.o: ../tcpserial/xkserial.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/46522b86
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/Cellar/jsoncpp/1.8.4/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/46522b86/xkserial.o ../tcpserial/xkserial.cpp
