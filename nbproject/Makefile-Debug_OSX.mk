...
LDLIBSOPTIONS=-lserialport -ljsoncpp
...
${OBJECTDIR}/_ext/e1dda48/basicserial.o: ../libterraclear/src/basicserial.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/Cellar/jsoncpp/1.8.4/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e1dda48/basicserial.o ../libterraclear/src/basicserial.cpp

${OBJECTDIR}/_ext/e1dda48/error_base.o: ../libterraclear/src/error_base.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/e1dda48
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/Cellar/jsoncpp/1.8.4/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e1dda48/error_base.o ../libterraclear/src/error_base.cpp

${OBJECTDIR}/_ext/e1dda48/thread_base.o: ../libterraclear/src/thread_base.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/e1dda48
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/Cellar/jsoncpp/1.8.4/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e1dda48/thread_base.o ../libterraclear/src/thread_base.cpp
...
${OBJECTDIR}/thread_serialrx.o: thread_serialrx.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/Cellar/jsoncpp/1.8.4/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thread_serialrx.o thread_serialrx.cpp
