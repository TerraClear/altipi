...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/altipi: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/altipi ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/altimeter.o: altimeter.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/altimeter.o altimeter.cpp
...
${OBJECTDIR}/thread_serialrx.o: thread_serialrx.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thread_serialrx.o thread_serialrx.cpp
...
${OBJECTDIR}/_ext/e1dda48/basicserial_nomain.o: ${OBJECTDIR}/_ext/e1dda48/basicserial.o ../libterraclear/src/basicserial.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e1dda48/basicserial_nomain.o ../libterraclear/src/basicserial.cpp;\
	else  \
...
${OBJECTDIR}/_ext/e1dda48/error_base_nomain.o: ${OBJECTDIR}/_ext/e1dda48/error_base.o ../libterraclear/src/error_base.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e1dda48/error_base_nomain.o ../libterraclear/src/error_base.cpp;\
	else  \
...
${OBJECTDIR}/_ext/e1dda48/thread_base_nomain.o: ${OBJECTDIR}/_ext/e1dda48/thread_base.o ../libterraclear/src/thread_base.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e1dda48/thread_base_nomain.o ../libterraclear/src/thread_base.cpp;\
	else  \
...
${OBJECTDIR}/altimeter_nomain.o: ${OBJECTDIR}/altimeter.o altimeter.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/altimeter_nomain.o altimeter.cpp;\
	else  \
...
${OBJECTDIR}/thread_serialrx_nomain.o: ${OBJECTDIR}/thread_serialrx.o thread_serialrx.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thread_serialrx_nomain.o thread_serialrx.cpp;\
	else  \
